    ...
    <div style="margin:0 -20px;">
      <el-row class="panel-group">
        <el-col :xs="24" :sm="24" :lg="12" class="panel-group-col">
          <div class="div-css">
            <div>
              <icon name="item" scale="2" style="padding-right: 5px; margin-left: -10px; float:left; margin-top:10px"></icon><span class="item-font">客户基本信息</span>
            </div>
            <div style="height:265px;overflow:scroll">
              <el-table :data="userData" size="mini">
                ...
                <el-table-column prop="customer_address" label="装机地址" align="center"></el-table-column>
                <el-table-column prop="line_code" label="接入号" align="center"></el-table-column>
              </el-table>
            </div>
          </div>
        </el-col>
        ...
        <el-col :xs="24" :sm="24" :lg="12" class="panel-group-col">
          <div class="div-css">
            <icon name="item" scale="2" style="padding-right: 5px; margin-left: -10px; float:left; margin-top:10px"></icon><span class="item-font">TOP5云域名</span>
            <div style="height:280px;overflow:scroll">
              <el-table
                  :data="top5CloudDomain"
                  size="mini">
                <el-table-column prop="rank" label="排名" align="center" type="index">
                </el-table-column>
                <el-table-column prop="tld" label="域名" align="center">
                </el-table-column>
                <el-table-column prop="csp_name" label="公有云" align="center">
                </el-table-column>
        ...
        <el-col :xs="24" :sm="24" :lg="12" class="panel-group-col">
          <div class="div-css">
            <icon name="item" scale="2" style="padding-right: 5px; margin-left: -10px; float:left; margin-top:10px"></icon><span class="item-font">TOP5非云域名</span>
            <div style="height:270px;overflow:scroll">
              <el-table
                  :data="top5NotCloudDomain"
                  size="mini">
                <el-table-column prop="rank" label="排名" align="center" type="index">
                </el-table-column>
                <el-table-column prop="tld" label="域名" align="center">
