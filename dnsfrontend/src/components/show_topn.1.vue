      ...
      <el-row class="panel-group">
        <el-col :xs="24" :sm="24" :lg="24" class="panel-group-col">
          <el-row>
            <el-col :xs="24" :sm="24" :lg="24" class="panel-group-col">
              <div class="test">
                <span style="text-align:center; font-size:30px; color:#43CAF2; line-height: 100px;">DNS展板</span>
              </div>
              <div>
                <el-button-group style="float:right; margin-top: -70px; margin-right:10px">
...
<!--               <div>
              ...
              <span class="item-font">TOPN1</span>
...
<!--                 <div>
                ...
                <span class="item-font">TOPN2</span>
                <div id="chart3" style="display:inline-block"></div>
                <div>
<!--                   <div class="border-bottom-left"></div>
                  <div class="border-bottom-right"></div> -->
...
<!--                 <div>
                ...
                <span class="item-font">TOPN3</span>
...
<!--                   <div class="border-bottom-left"></div>
        ...
        <el-col :xs="8" :sm="8" :lg="14" class="panel-group-col" id="chart">
          <el-row>
            <el-col :xs="24" :sm="24" :lg="24" class="panel-group-col">
              <div class="div-css" :style="{height:heightData - 150 + 'px'}" id="chart_1">
<!--                 <div>
                  <div class="border-top-left"></div>
                  <div class="border-top-right"></div>
                </div> -->
...
<!--                 <div>
            ...
            <el-col :xs="24" :sm="24" :lg="24" class="panel-group-col">
              <div class="div-css" :style="{height:heightData + 200 + 'px'}" id="chart_map">
                <div class="chart-css">
                  <div id="dt1" style="display:inline-block; float:left"></div>
                  <div>
                    <span class="item-font">各地市访问量</span>
                    <div id="zzt1" style="display:inline-block;"></div>
                  </div>
                </div>
              </div>
            </el-col>
...
<!--                         <div>
                        ...
                        <span class="item-font">趋势图1</span>
...
<!--                         <div>
                        ...
                        <span class="item-font">用户访问量趋势</span>
                        <div class="chart-css">
          ...
          <el-row>
            <el-col :xs="24" :sm="24" :lg="24" class="panel-group-col" id="chart_bzt">
              <div class="div-css" :style="{height:heightData + 'px'}">
                ...
                <span class="item-font">饼状图1</span>
                <div class="chart-css">
            ...
            <el-col :xs="24" :sm="24" :lg="24" class="panel-group-col">
              <div class="div-css" :style="{height:heightData + 'px'}">
                ...
                <span class="item-font">饼状图2</span>
                <div>
                  <div class="border-bottom-left"></div>
                  <div class="border-bottom-right"></div>
                </div>
            ...
            <el-col :xs="24" :sm="24" :lg="24" class="panel-group-col">
              <div class="div-css" :style="{height:heightData + 'px'}">
                ...
                <span class="item-font">饼状图3</span>
                <div>
                  <div class="border-bottom-left"></div>
                  <div class="border-bottom-right"></div>
                </div>
        ...
        this.$http({
          ...
          setTimeout(() => {
            ...
            var chartContainer = function () {
                ...
                zzt1.style.height = (chart2.clientHeight - 30) +'px';
            };
            chartContainer();
            this.zzt1 = zzt1;
